...
import java.util.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		public static void Create_Hyderabad_Map(Graph_M g) {
    ...
    g.addEdge("Lakdi-ka-pul~R", "MG Bus Station~RG", 2);
    g.addEdge("MG Bus Station~RG", "Malakpet~R", 2);
    g.addEdge("Malakpet~R", "Dilsukhnagar~R", 2);
    g.addEdge("Dilsukhnagar~R", "LB Nagar~R", 2);
    ...
    g.addEdge("Uppal~B", "Stadium~B", 1);
    g.addEdge("Stadium~B", "NGRI~B", 1);
    g.addEdge("NGRI~B", "Habsiguda~B", 1);
    g.addEdge("Habsiguda~B", "Tarnaka~B", 1);
    g.addEdge("Tarnaka~B", "Mettuguda~B", 1);
    g.addEdge("Mettuguda~B", "Secunderabad East~B", 1);
    g.addEdge("Secunderabad East~B", "Parade Ground~B", 1);
    g.addEdge("Parade Ground~B", "Paradise~B", 1);
    g.addEdge("Paradise~B", "Rasoolpura~B", 1);
    g.addEdge("Rasoolpura~B", "Prakash Nagar~B", 1);
    g.addEdge("Prakash Nagar~B", "Begumpet~B", 1);
    g.addEdge("Begumpet~B", "Ameerpet~RB", 1);
    g.addEdge("Ameerpet~RB", "Madhura Nagar~B", 1);
    g.addEdge("Madhura Nagar~B", "Yousufguda~B", 1);
    g.addEdge("Yousufguda~B", "Jubilee Hills Check Post~B", 1);
    g.addEdge("Jubilee Hills Check Post~B", "Durgam Cheruvu~B", 1);
    g.addEdge("Durgam Cheruvu~B", "Raidurg~B", 1);
}
